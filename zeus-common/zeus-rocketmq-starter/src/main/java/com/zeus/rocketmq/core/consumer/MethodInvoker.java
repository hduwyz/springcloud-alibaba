...
import com.zeus.rocketmq.extension.InterceptorHook;
import com.zeus.rocketmq.extension.InterceptorHookAware;
 ...
 * 该类注册到Spring容器进行管理
 */
public class MethodInvoker implements InterceptorHookAware {
    ...
    @Override
    public void setHook(InterceptorHook hook) {
        this.hook = hook;
    }
